...
// }
// const allnotes1 = note_10 || note_20 || note_50 || note_100 || note_500 || note_1000 || note_5000;


// if (note_10 === parseInt(note10) * 10 || note_20 = parseInt(note20) * 20 ||) {
//     alert()
// }
// var eidi = 0;
// alert(parseInt(allnotes) || parseInt(allnotes1) * 1)
// var noname = document.getElementById("input1")


// if (noname.value === "") {
//     alert("Enter Reciever Name Please");
// } else {
